...
pub fn sim_pin_verify(_state: &AppState, body: &[u8]) -> (u16, Value) {
    ...
    match ubus::call("zwrt_zte_mdm.api", "sim_verify_pin_puk", Some(&parsed.to_string())) {
        Ok(data) => (200, json!({"ok": true, "data": data})),
        Err(e) => (503, json!({"ok": false, "error": e})),
    }
}
...
pub fn sim_pin_change(_state: &AppState, body: &[u8]) -> (u16, Value) {
    ...
    match ubus::call("zwrt_zte_mdm.api", "sim_change_pin", Some(&parsed.to_string())) {
        Ok(data) => (200, json!({"ok": true, "data": data})),
        Err(e) => (503, json!({"ok": false, "error": e})),
    }
}
...
pub fn sim_pin_mode(_state: &AppState, body: &[u8]) -> (u16, Value) {
    ...
    match ubus::call("zwrt_zte_mdm.api", "sim_change_pin_mode", Some(&parsed.to_string())) {
        Ok(data) => (200, json!({"ok": true, "data": data})),
        Err(e) => (503, json!({"ok": false, "error": e})),
    }
}
...
pub fn sim_unlock(_state: &AppState, body: &[u8]) -> (u16, Value) {
    ...
    match ubus::call("zwrt_zte_mdm.api", "set_simlock_nck", Some(&parsed.to_string())) {
        Ok(data) => (200, json!({"ok": true, "data": data})),
        Err(e) => (503, json!({"ok": false, "error": e})),
    }
}
...
pub fn sim_lock_trials(_state: &AppState) -> (u16, Value) {
    match ubus::call("zwrt_zte_mdm.api", "get_simlock_available_trials", Some("{}")) {
        Ok(data) => (200, json!({"ok": true, "data": data})),
        Err(e) => (503, json!({"ok": false, "error": e})),
    }
}
